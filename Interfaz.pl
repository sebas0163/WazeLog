...
/*
 Descripcion: verifica si se menciona una ciudad en laoracion.
 verifica_ciudad(lista con las palabras de la oracion, ciudad mencionada en la oracion)
*/
verifica_ciudad([Elem|_],Elem):-ciudad(Elem).
verifica_ciudad([_|Resto],Elem):- verifica_ciudad(Resto, Elem).

/*
Descripcion: verifica si se menciona un lugar en la oracion
verifica_lugar(lista con las palabras de la oracion, lugar mencionado en la oracion)
*/
verifica_lugar([Elem|_],Elem):-lugar(Elem).
verifica_lugar([_|Resto],Elem):- verifica_lugar(Resto, Elem).

/*
Mensaje presentado cuando el usuario ingresa una oracion no mal estructurada o ssin sentido para el contexto del programa
*/
...
/*
  ...
  oracion_valida(Lugar identificado en la oracion)
  */
...
/*
 Descripción:Se encarga de verificar que en la oracion dada haya
 como minimo un nombre de ciudad.
 Verificador_de_lugaryciudad(Lista de palabras,Ciudad encontrada en las palabras)
*/
